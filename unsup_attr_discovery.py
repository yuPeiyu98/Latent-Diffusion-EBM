...
def compute_features(args, data_feed, model, verbose=True):
    ...
    while True:
        ...
        mu, __ = model.encoder(sents, args)
...
def main(args, output_dir):
    ...
    while epoch < args.num_epochs:
        ...
        features, data_gathered = compute_features(args, train_feed, model, verbose=True)
        ...
        for i, (sents, pseudo_labels) in enumerate(train_dataloader):
            ...
            # ae_train = True if epoch < 2 else False
            ...
            x_pos, x_neg, x_T_1, x_T, t = model.prior_network.sample_latent_training_pairs(z_samples)
            ...
            logits = model.prior_network.ebm_prior(z0, t0, use_cls_output=True)
