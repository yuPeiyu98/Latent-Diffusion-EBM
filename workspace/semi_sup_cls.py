...
def parse_args():
    ...
    parser.add_argument('--max_kl_weight', type=float, default=1e-3)
    parser.add_argument('--mutual_weight', type=float, default=5)
...
def train(args_job, output_dir_job, output_dir, return_dict):
    ...
    def classification(dataloader, netI, netE):
        ...
        for i, (x, y) in enumerate(dataloader):
            ...
            z0 = mu * netE._extract(netE.a_s_prev, t0 + 1, mu.shape)
            scores = netE.ebm_prior(z0, t0, use_cls_output=True)
