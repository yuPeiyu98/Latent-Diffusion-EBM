...
parser.add_argument('--max_kl_weight', type=float, default=10)
parser.add_argument('--mutual_weight', type=float, default=10)
parser.add_argument('--cls_weight', type=float, default=5)
...
def eval(
    ...
    while True:
        ...
        if do_generation_cond_y:
            ...
            cluster_keys = list(range(125)) # cluster_keys if len(cluster_keys) <= max_num_cluster else cluster_keys[:max_num_cluster]
            ...
            if epoch == 16:
                for ctx_id in range(0, ctx_encoding.size(0)):
